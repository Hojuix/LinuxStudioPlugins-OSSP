...
CFLAGS="-fPIC -O2 -fvisibility=hidden -fno-exceptions -fno-rtti -fdata-sections -ffunction-sections -fno-asynchronous-unwind-tables -pipe -Wall -I ."
SYSROOT="/usr/local"
...
mkdir -p build-lsp-dsp-lib/src/main/x86

build_lsp_dsp_lib "lsp-dsp-lib/src/main/dsp.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/generic/generic.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/avx.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/avx2.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/avx512.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/sse.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/sse2.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/sse3.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/sse4.cpp"
build_lsp_dsp_lib "lsp-dsp-lib/src/main/x86/x86.cpp"
...
$LD \
    ...
    -r build-lsp-dsp-lib/src/main/x86/avx.o \
    -r build-lsp-dsp-lib/src/main/x86/avx2.o \
    -r build-lsp-dsp-lib/src/main/x86/avx512.o \
    -r build-lsp-dsp-lib/src/main/x86/sse.o \
    -r build-lsp-dsp-lib/src/main/x86/sse2.o \
    -r build-lsp-dsp-lib/src/main/x86/sse3.o \
    -r build-lsp-dsp-lib/src/main/x86/sse4.o \
    -r build-lsp-dsp-lib/src/main/x86/x86.o
...
$CXX \
    ...
    -fPIC -O2 -fvisibility=hidden -fno-exceptions -fno-rtti -fdata-sections -ffunction-sections \
...
$CXX \
    ...
    -Wl,-z,relro,-z,now -Wl,--gc-sections -Wl,-as-needed -shared -fPIC -lsndfile

...
#LD=/opt/android31/bin/ld.lld
#CXX=/opt/android31/bin/aarch64-linux-android31-clang++
LD=ld
CXX=g++
...
$CXX \
    ...
    -march=armv8-a -Wl,-z,relro,-z,now -Wl,--gc-sections -Wl,-as-needed -shared -fPIC -ldl -lpthread -lrt -lsndfile
